$(document).ready(function () {
    ...
    $("#downloadCSV").click(function () {
        ...
        for (let index = 0; index < headings.length; index++) {
            headerss+='<td>'+headings[index]+'</td>';
        }
        for (let indexdata = 0; indexdata < data.length; indexdata++) {
            databody+='<tr>';
            for (let indexsubdata = 0; indexsubdata < data[indexdata].length; indexsubdata++) {
                databody+='<td>'+data[indexdata][indexsubdata]+'</td>';
            }
            databody+='</tr>';
        }
        var excelTemplate="";
        excelTemplate += '<html> ' +
            ...
            '<thead>' +
            '<tr>' ;
        excelTemplate += headerss;
        excelTemplate += '</tr>' +
            '</thead>' +
            '<tbody>' ;
        excelTemplate +=databody;
        excelTemplate +='</tbody>' +
            '</table>' +
            '</body> ' +
            '</html>';
